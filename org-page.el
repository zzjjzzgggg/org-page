...
;; 11) index/contact page support (auto generated if no default provided)
;; 12) site preview
...
perfectly manipulated by org-page."
  ...
  (op/generate-contact repo-dir)
  (op/git-commit-changes repo-dir "add source contact.org")
  (mkdir (expand-file-name "article/" repo-dir) t))
...
(defun op/generate-contact (save-dir)
  "Generate contact.org for `op/new-repository'. SAVE-DIR is the directory where
to save generated contact.org."
  (string-to-file
   (concat "#+TITLE: Contact" "\n\n"
           (format "* Contact %s" (or user-full-name "[Author]")) "\n\n"
           "  This file is automatically generated by org-page.")
   (expand-file-name "contact.org" save-dir)))
